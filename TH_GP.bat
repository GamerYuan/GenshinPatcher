...
for /F "usebackq delims=" %%i in ("!WorkingDirForAdmin!GenshinImpact_Data\Persistent\audio_lang_14") do (
	...
	REM Check if required TH_GP_AudioPatch_[language]_oldVer-newVer.txt files are present, variable will be set to true if at least one file is missing. All missing files will be listed.
	if NOT exist "!WorkingDirForAdmin!TH_GP_AudioPatch_!CurrentLanguage!_!oldVer!-!newVer!.txt" (
		echo "TH_GP_AudioPatch_!CurrentLanguage!_!oldVer!-!newVer!.txt" is missing.
		set FileMissing=True
		set CurrentLanguage=None
	)
)
if NOT exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Common_!oldVer!-!newVer!.txt" (
	echo "TH_GP_AudioPatch_Common_!oldVer!-!newVer!.txt" is missing.
	set FileMissing=True
)
...
robocopy "!WorkingDirForAdmin!GenshinImpact_Data\Persistent\AudioAssets" "!WorkingDirForAdmin!GenshinImpact_Data\StreamingAssets\AudioAssets" /e /copy:DAT /dcopy:DAT /move
...
for /L %%i in (1,1,4) do (
	...
	if NOT "!CurrentLanguage!"=="None" (
		...
		for /F "usebackq delims=" %%j in ("!WorkingDirForAdmin!TH_GP_AudioPatch_!CurrentLanguage!_!oldVer!-!newVer!.txt") do (
			if NOT exist "!WorkingDirForAdmin!GenshinImpact_Data\StreamingAssets\AudioAssets\!LangCheck!\%%~nxj" (
				
				echo "!WorkingDirForAdmin!GenshinImpact_Data\StreamingAssets\AudioAssets\!LangCheck!\%%~nxj" is missing.
				set FileMissing=True
			)
...
for /F "usebackq delims=" %%i in ("!WorkingDirForAdmin!TH_GP_AudioPatch_Common_!oldVer!-!newVer!.txt") do (
	if NOT exist "!WorkingDirForAdmin!GenshinImpact_Data\StreamingAssets\AudioAssets\%%~nxi" (
		echo "!WorkingDirForAdmin!GenshinImpact_Data\StreamingAssets\AudioAssets\%%~nxi" is missing.
		set FileMissing=True
	)
...
for /L %%i in (1,1,4) do (
	...
	if NOT "!CurrentLanguage!"=="None" (
		...
		for /F "usebackq delims=" %%k in ("!WorkingDirForAdmin!TH_GP_AudioPatch_!CurrentLanguage!_!oldVer!-!newVer!.txt") do (
...
for /F "usebackq delims=" %%i in ("!WorkingDirForAdmin!TH_GP_Cleanup_!oldVer!-!newVer!.txt") do (
...
REM Delete source file for TH_GP_Cleanup_oldVer-newVer.txt and the file itself.
if exist "!WorkingDirForAdmin!deletefiles.txt" (
	del "!WorkingDirForAdmin!deletefiles.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_Cleanup_!oldVer!-!newVer!.txt" (
	del "!WorkingDirForAdmin!TH_GP_Cleanup_!oldVer!-!newVer!.txt"
)
REM Delete source file for TH_GP_AudioPatch_[language]_oldVer-newVer.txt and the file itself.
if exist "!WorkingDirForAdmin!hdifffiles.txt" (
	del "!WorkingDirForAdmin!hdifffiles.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Common_!oldVer!-!newVer!.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Common_!oldVer!-!newVer!.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Chinese_!oldVer!-!newVer!.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Chinese_!oldVer!-!newVer!.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_English_!oldVer!-!newVer!.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_English_!oldVer!-!newVer!.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Japanese_!oldVer!-!newVer!.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Japanese_!oldVer!-!newVer!.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Korean_!oldVer!-!newVer!.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Korean_!oldVer!-!newVer!.txt"
)
...
if "%PatchFinished%"=="True" (
	if exist "!WorkingDirForAdmin!TH_GP_!oldVer!-!newVer!.bat" (
		del "!WorkingDirForAdmin!TH_GP_!oldVer!-!newVer!.bat"
	)
)