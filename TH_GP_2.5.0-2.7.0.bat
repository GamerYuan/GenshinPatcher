...
echo Checking if all necessary files to update the game from Patch 2.5.0 to 2.7.0 are present...
...
for /F "usebackq delims=" %%i in ("!WorkingDirForAdmin!GenshinImpact_Data\Persistent\audio_lang_14") do (
	...
	REM Check if required TH_GP_AudioPatch_[language]_2.5.0-2.7.0.txt files are present, variable will be set to true if at least one file is missing. All missing files will be listed.
	if NOT exist "!WorkingDirForAdmin!TH_GP_AudioPatch_!CurrentLanguage!_2.5.0-2.7.0.txt" (
		echo "TH_GP_AudioPatch_!CurrentLanguage!_2.5.0-2.7.0.txt" is missing.
		set FileMissing=True
		set CurrentLanguage=None
	)
)
if NOT exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Common_2.5.0-2.7.0.txt" (
	echo "TH_GP_AudioPatch_Common_2.5.0-2.7.0.txt" is missing.
	set FileMissing=True
)
...
for /L %%i in (1,1,4) do (
	...
	if NOT "!CurrentLanguage!"=="None" (
		for /F "usebackq delims=" %%j in ("!WorkingDirForAdmin!TH_GP_AudioPatch_!CurrentLanguage!_2.5.0-2.7.0.txt") do (
...
for /F "usebackq delims=" %%i in ("!WorkingDirForAdmin!TH_GP_AudioPatch_Common_2.5.0-2.7.0.txt") do (
...
for /L %%i in (1,1,4) do (
	...
	if NOT "!CurrentLanguage!"=="None" (
		...
		for /F "usebackq delims=" %%j in ("!WorkingDirForAdmin!TH_GP_Cleanup_!CurrentLanguage!_2.5.0-2.7.0.txt") do (
		...
		for /F "usebackq delims=" %%k in ("!WorkingDirForAdmin!TH_GP_AudioPatch_!CurrentLanguage!_2.5.0-2.7.0.txt") do (
...
for /F "usebackq delims=" %%i in ("!WorkingDirForAdmin!TH_GP_Cleanup_Common_2.5.0-2.7.0.txt") do (
...
REM Delete source file for TH_GP_Cleanup_[language]_2.5.0-2.7.0.txt and the file itself.
if exist "!WorkingDirForAdmin!deletefiles.txt" (
	del "!WorkingDirForAdmin!deletefiles.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_Cleanup_Common_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_Cleanup_Common_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_Cleanup_Chinese_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_Cleanup_Chinese_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_Cleanup_English_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_Cleanup_English_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_Cleanup_Japanese_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_Cleanup_Japanese_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_Cleanup_Korean_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_Cleanup_Korean_2.5.0-2.7.0.txt"
)
REM Delete source file for TH_GP_AudioPatch_[language]_2.5.0-2.7.0.txt and the file itself.
if exist "!WorkingDirForAdmin!hdifffiles.txt" (
	del "!WorkingDirForAdmin!hdifffiles.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Common_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Common_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Chinese_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Chinese_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_English_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_English_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Japanese_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Japanese_2.5.0-2.7.0.txt"
)
if exist "!WorkingDirForAdmin!TH_GP_AudioPatch_Korean_2.5.0-2.7.0.txt" (
	del "!WorkingDirForAdmin!TH_GP_AudioPatch_Korean_2.5.0-2.7.0.txt"
)
...
if "%PatchFinished%"=="True" (
	if exist "!WorkingDirForAdmin!TH_GP_2.5.0-2.7.0.bat" (
		del "!WorkingDirForAdmin!TH_GP_2.5.0-2.7.0.bat"
	)
)